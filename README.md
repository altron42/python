...
Defina a função `maiorseq2(mao)` similar à `maiorseq(mao)` exceto que para esse caso, considere que a 13ª e a 1ª cartas de qualquer naipe, são consideradas sequências válidas. Por exemplo:
```python
